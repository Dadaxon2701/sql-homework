...
-- 1️⃣ Orders after 2022 with Customer Names
SELECT 
    O.OrderID, 
    C.CustomerName, 
    O.OrderDate
...
-- 2️⃣ Employees in Sales or Marketing Department
SELECT 
    E.EmployeeName, 
    D.DepartmentName
FROM Employees E
...
-- 4️⃣ USA Customers with Orders in 2023
SELECT 
    C.CustomerName, 
    O.OrderID, 
    O.OrderDate
...
-- 7️⃣ Most Recent Order per Customer (Include Customers with No Orders)
SELECT 
    C.CustomerName, 
...
-- 9️⃣ Product Sales in 2022 or SaleAmount > 400
SELECT 
    P.ProductName, 
    S.SaleDate, 
    S.SaleAmount
...
-- 1️⃣1️⃣ HR Employees with Salary > 60000
SELECT 
    E.EmployeeName, 
    D.DepartmentName, 
    E.Salary
...
-- 1️⃣2️⃣ Products Sold in 2023 with Stock > 100
SELECT 
    P.ProductName, 
    S.SaleDate, 
    P.StockQuantity
...
-- 1️⃣3️⃣ Employees in Sales Department or Hired After 2020
SELECT 
    E.EmployeeName, 
    D.DepartmentName, 
    E.HireDate
...
-- 1️⃣4️⃣ USA Customers with Address Starting with 4 Digits
SELECT 
    O.OrderID, 
    C.CustomerName, 
    C.Address, 
...
-- 1️⃣5️⃣ Electronics Products or Sale > 350
SELECT 
    P.ProductName, 
    P.Category, 
    S.SaleAmount
...
-- 1️⃣6️⃣ Product Count per Category
SELECT 
    CategoryName, 
...
-- 1️⃣7️⃣ Orders from Los Angeles with Amount > 300
SELECT 
    C.CustomerName, 
    C.City, 
    O.OrderID, 
...
-- 1️⃣8️⃣ Employees in HR or Finance or Names with >=4 Vowels
SELECT 
    E.EmployeeName, 
    D.DepartmentName
FROM Employees E
...
WHERE D.DepartmentName IN ('HR', 'Finance')
   OR LENGTH(E.EmployeeName) - LENGTH(REPLACE(LOWER(E.EmployeeName), 'a', '')) 
       + LENGTH(E.EmployeeName) - LENGTH(REPLACE(LOWER(E.EmployeeName), 'e', '')) 
       + LENGTH(E.EmployeeName) - LENGTH(REPLACE(LOWER(E.EmployeeName), 'i', '')) 
       + LENGTH(E.EmployeeName) - LENGTH(REPLACE(LOWER(E.EmployeeName), 'o', '')) 
       + LENGTH(E.EmployeeName) - LENGTH(REPLACE(LOWER(E.EmployeeName), 'u', '')) >= 4;


-- 1️⃣9️⃣ Sales or Marketing Employees with Salary > 60000
SELECT 
    E.EmployeeName, 
    D.DepartmentName, 
    E.Salary
